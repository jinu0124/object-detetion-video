...
COCO_WEIGHTS_PATH = "C://Users/jinwo/Mask_RCNN-master/Mask_RCNN-master/mask_rcnn_coco.h5"
...
class loadDataset(utils.Dataset):
    ...
    def load_load(self, dataset_dir, subset):
        """Load a subset of the load dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes. We have only one class to add.
        self.add_class("line", 1, "car")
        self.add_class("line", 2, "Slane")
        self.add_class("line", 3, "Llane")
        ...
        print("annotations 수(이미지 수)", len(annotations))
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "line": # NAME
...
def train(model):
    ...
    dataset_train.load_load(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = loadDataset()
    dataset_val.load_load(args.dataset, "val")
    dataset_val.prepare()
    ...
    model.train(dataset_train, dataset_val,
                ...
                epochs=15,
                layers='heads')# 3+는 Trained model에서 layer 3+층이후부터 Update
